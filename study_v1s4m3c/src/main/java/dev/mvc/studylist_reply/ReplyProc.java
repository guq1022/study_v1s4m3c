...
//    str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
    ...
    int _nowPage = (nowGrp-1) * Reply.PAGE_PER_BLOCK; // 이전 페이지로 이동 
      ...
      if (nowGrp >= 2){ 
        str.append("<span class='span_box_1'><A onclick='reply_List("+stdlist_no+","+_nowPage+");'>이전</A></span>"); 
      ...
      for(int i=startPage; i<=endPage; i++){ 
       ...
       if (nowPage == i){ 
          str.append("<span class='span_box_2'><A onclick='reply_List("+stdlist_no+","+i+");'>"+i+"</A></span>"); // 현재 페이지, 강조 
        }else{
          
          // 현재 페이지가 아닌 페이지
          str.append("<span class='span_box_1'><A onclick='reply_List("+stdlist_no+","+i+")'>"+i+"</A></span>");
        } 
      } 
      ...
      if (nowGrp < totalGrp){ 
        str.append("<span class='span_box_1'><A onclick='reply_List("+stdlist_no+","+_nowPage+");'>다음</A></span>"); 
