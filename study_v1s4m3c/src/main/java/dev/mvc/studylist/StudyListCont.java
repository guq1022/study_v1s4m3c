...
//==============이동석=====================================//
  ...
  public ModelAndView update(HttpSession session, StudyListVO studyListVO) {
    ...
    if (studylistProc.update(studyListVO) == 1) {
      ...
      mav.setViewName("redirect:/nonuser/studylist/read.do?stdlist_no="+studyListVO.getStdlist_no()+"&memberno="+memberno); // 확장자 명시 
  ...
  public String delete(int stdlist_no) {
    ...
    catelistProc.delete(stdlist_no);
