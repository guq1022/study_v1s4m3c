    ...
    <DIV class='content'>
        ...
        <div style='width: 80%; height:100px;'>
          <div style='float: right; margin-top: 30px; margin-bottom:20px;'>
            ...
            <c:when test="${readVO.memberno == sessionScope.memberno}">
              <button type='button' class='btn btn-default' onclick="location.href='/study/user/recruit/recruit_list.do?stdlist_no=${readVO.stdlist_no}'">신청리스트</button>
              <button type='button' class='btn btn-default' id='update_form'>수정</button>
              <button type='button' class='btn btn-default' onclick='javascript:alert_delete_form()'>삭제</button>
            </c:when>
            </c:choose>
          </div>
        </div>
      ...
      <DIV style='width: 80%; margin: 0px auto;'>
        ...
        <div style='float: left; margin-left: 10%;'>
          ...
          <div class="form-group" style='padding: 20px; margin: 0; width:400px'>
            <label for="stdlist_mememail" class="col-md-3 control-label" style='width:17%;'>이메일</label>
            <div class="col-md-7" style='text-align: left;'>
      ...
      <FORM name='reply' id='reply_create' action="" style="text-align: left; width: 50%; height:40px; padding-bottom: 5%; margin: 0px auto;">
        ...
        <div id='reply_list' style='margin-top:70px; width: 60%; margin: 0px auto; padding-bottom:50px;'></div>
