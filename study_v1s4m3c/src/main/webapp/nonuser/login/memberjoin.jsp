...
$(function(){     
  ...
  $('#email_btn').click(function(){    
    ...
    if(mememail== '' || mememail==null) {
      ...
      if(limitmail.test(mememail) == false) {
        ...
        $.ajax({
          type: 'GET',
          url: '/study/login/check_email.do',
          cache: false,
          data: mememail,       
          dataType: 'JSON',        
          success: function(data){
  ...
  $('#code_btn').click(function(){    
    ...
    if ($.cookie('check_email') != 'TRUE') { // 중복 검사 실패
      ...
      $.ajax({
        type: 'POST',
        url: '/study/login/mailSending.do',
  ...
  $('#codecf_btn').click(function(){        
    ...
    if ($.cookie('code_send') != 'TRUE') { //  코드 발송 실패
...
<DIV class='content' style='width: 90%; margin: 0px auto; text-align: center;'>
  ...
  <ASIDE style='float: right;'>
    ...
    <A href='../member/mem_list.do'>회원 목록</A>
  </ASIDE>
